...
The primary crawler is the `newsboard-crawl` Edge Function, invoked by one Supabase Cron job every five minutes. Seven HTTP publishers are enabled; five retain the manual browser backup.
